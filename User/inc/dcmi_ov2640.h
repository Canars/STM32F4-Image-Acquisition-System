...
typedef enum   
{
  ...
  JPEG_320x480          =   0x05,     /* JPEG Image 320x480 Size */
}ImageFormat_TypeDef;
...
#define DCMI_DR_ADDRESS       	0x50050028  //DCMI_DR寄存器地址 
